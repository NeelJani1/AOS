...
def train(train_loader, model, criterion, optimizer, epoch, args, mask=None, scaler=None):
    """
    Enhanced training function with mask verification
    """
...
def apply_mask_to_gradients(model, mask):
    """
    Apply mask to zero out gradients for masked parameters
    """
    if mask is None:
        return
